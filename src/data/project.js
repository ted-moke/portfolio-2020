    ...
    list: [
        {
            id: 'train-n-play',
            client: 'Nike',
            project: "Train N' Play AR Game",
            role: [{name: 'Developer'}],
            description: "As one of two developers, I was responsible for developing the instructions, menu and shop user interfaces; a reusable virtual ‘trainer’ terminal; and the app’s sound design. Built in JavaScript for a browser frontend with a custom framework.",
        ...
        },
        {
            ...
            role: [{name:'Lead Developer'}, {name:'Electrical Engineer'}],
